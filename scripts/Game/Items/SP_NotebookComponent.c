...
class SP_NotebookComponent : ScriptGameComponent
{
	...
	[Attribute(defvalue: "{3497CC61DCCCC2A6}Assets/Items/Notebook.edds")]
	protected ResourceName m_BookImageOverride;
	
	ref array <ref SP_NotebookPage> m_aPages = {};
	
	ResourceName GetBookImage()
	{
		return m_BookImageOverride;
	}
